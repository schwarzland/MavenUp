...
- Added a toolbar in the **Dependency Hierarchy** dialog with **Expand All**, **Collapse All**, **Navigate to pom.xml**, and **Navigate to ...** actions for quick tree navigation and jumping to the component in the main table.
- Added a **Navigate to ...** action to the toolbar and context menu of the **Dependency Hierarchy** dialog that closes the dialog, resets all filters, and selects the matching row in the main dependencies table.
