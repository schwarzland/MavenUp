...
- **Configurable auto-selection strategy**: After an update check, MavenUp provides a 3-state strategy (disabled, highest version, latest minor in current major line) for preselecting the target version.
