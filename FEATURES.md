...
- **Detailed vulnerability intelligence**: Retrieves advisory identifiers, aliases, summaries, severity/CVSS information (including the CVSS vector), fixed-in versions, references, and source attribution; unsupported CVSS vectors fall back to source severity without dropping the advisory.
