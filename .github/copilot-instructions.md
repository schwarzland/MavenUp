...
2. **CHANGELOG.md** ergänzen/aktualisieren mit einem passenden Eintrag zur Änderung. Sprache: Englisch.
...
4. **plugin.xml** ergänze/aktualisiere die Sektion <description>, wenn neue Funktionen  hinzugefügt oder bestehende Funktionen geändert werden. Sprache: Englisch.
