...
1. **Refresh**: Lädt die Projektdaten neu, befüllt die Tabelle und setzt die Spalte **New Version** zurück. Währenddessen ist **Check Vulnerabilities** deaktiviert. (Beim **Find New Versions** bleiben die neu geladenen Werte erhalten.)
2. **Find New Versions**: Sucht online nach verfügbaren Versionen für alle gelisteten Einträge; **Check Vulnerabilities** bleibt bis zum Abschluss deaktiviert.
...
2. **Find New Versions**: Searches online for available versions for all listed entries; **Check Vulnerabilities** remains disabled until completion.
