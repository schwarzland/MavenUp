...
- **Versions-Status-Anzeige**: Die Spalte **New Version** zeigt ein grünes Häkchen und grünen Text, wenn die ausgewählte Version der höchsten bekannten Version entspricht, oder ein orangefarbenes Pfeil-Icon und orangefarbenen Text, wenn nicht. Icon und Farbe passen sich immer an die aktuell im Dropdown gewählte Version an. Wird eine andere Version als die aktuelle gewählt, wird der Dropdown-Text fett dargestellt, um eine ausstehende Änderung zu signalisieren. Ein Tooltip zeigt die Statusdetails; die Farben passen sich an Light- und Dark-Theme an.
