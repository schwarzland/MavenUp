...
11. **Sortierung**: Ein Klick auf eine Spaltenüberschrift schaltet die Sortierung zyklisch weiter: aufsteigend, absteigend und zurück zur ursprünglichen Reihenfolge aus der `pom.xml`. Die Spalte **Current Version** wird versionsbewusst sortiert (z.B. `1.10` nach `1.9`); die Spalten **Vulnerabilities (Current)** und **New Version** sind von der Sortierung ausgenommen.
