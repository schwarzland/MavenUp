...
- **Umbrechende Toolbar**: Ist das Tool-Window zu schmal, um alle Aktions-Buttons in einer Zeile darzustellen, brechen die Buttons automatisch in mehrere Zeilen um, sodass kein Button unerreichbar wird.
