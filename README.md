...
4. **Höchste Major-/Minor-Version wählen und zurücksetzen**: Drei im Aktionsleisten-Aufklappmenü **Bulk Selection** gebündelte Aktionen setzen mit einem Klick Zielversionen: **Select Highest Major Version** wählt die höchste verfügbare Version (auch über Major-Linien hinweg) und **Select Highest Minor Version** die höchste Version innerhalb der aktuellen Major-Linie jeder Dependency – beide wirken nur auf die aktuell sichtbaren (nicht ausgefilterten) Zeilen und zeigen bei aktivem Filter einen Tooltip-Hinweis. **Reset to Current Versions** verwirft alle Auswahlen und stellt die aktuellen Versionen wieder her – unabhängig vom Filter.
